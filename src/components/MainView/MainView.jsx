...
export function MainView() {
  ...
  // Fältval för respektive vy
  const [selectedSummaryFields, setSelectedSummaryFields] = useState(['video_views', 'reach', 'likes', 'comments', 'shares']);
  const [selectedVideoFields, setSelectedVideoFields] = useState(['views', 'likes', 'comments', 'shares']);
